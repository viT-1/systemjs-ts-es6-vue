...
describe('vuex MainFilter iamSelect mutations', () => {
	it(`after ${confMutations.IamSelect.SOME_VALUES_SET} mutation state have points & flush value`, () => {
		expect.assertions(1);
		...
		mutations[confMutations.IamSelect.SOME_VALUES_SET](state, points);
	...
	it(`after ${confMutations.IamSelect.SOME_VALUE_SELECT} mutation state show us active value`, () => {
		expect.assertions(1);
		...
		mutations[confMutations.IamSelect.SOME_VALUE_SELECT](state, value);
